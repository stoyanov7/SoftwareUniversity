namespace RequestParser
{
    ...
    public class Startup
    {
        public static void Main(string[] args)
        {
            ...
            var requestArgs = requestLine.Split(new [] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            if (!methodPaths.ContainsKey(methodName) || methodPaths[methodName].All(p => p != pathName))
            {
