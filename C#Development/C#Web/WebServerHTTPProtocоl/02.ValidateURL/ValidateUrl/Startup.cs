namespace ValidateUrl
{
    ...
    public class Startup
    {
        public static void Main(string[] args)
        {
            ...
            var protocol = urlMatch.Groups[1].Value.Trim(new[] { '/', ':' });
            ...
            if (port == string.Empty && protocol == "http")
            {
                port = "80";
            }
            else if (port == string.Empty && protocol == "https")
            {
                port = "443";
            }
            ...
            if (queryStrings != "")
            {
                sb.AppendLine($"Query: {queryStrings}");
            }
