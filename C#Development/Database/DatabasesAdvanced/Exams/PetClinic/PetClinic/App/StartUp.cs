namespace PetClinic.App
{
    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(PetClinicContext context, string baseDir = @"..\Datasets\")
        {
            ...
            var animalAids = DataProcessor.Deserializer.ImportAnimalAids(context, File.ReadAllText(baseDir + "animalAids.json"));
            PrintAndExportEntityToFile(animalAids, exportDir + "AnimalAidsImport.txt");

            var animals = DataProcessor.Deserializer.ImportAnimals(context, File.ReadAllText(baseDir + "animals.json"));
