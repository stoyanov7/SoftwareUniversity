namespace PhotoShare.Utilities
{
    ...
    /// <summary>
    /// Transforms given tag to valid one by rules.
    /// </summary>
    public static class TagUtilities
    {
        ...
        public static string ValidateOrTransform(this string wrongTag)
        {
            ...
            var transformedTag = RemoveAllWhiteSpaces(wrongTag);
        ...
        private static string AppendPoundSign(string tag) => "#" + tag;

        private static string ReduceStringLength(string tag, int length) => tag.Substring(0, length);
    }
}
